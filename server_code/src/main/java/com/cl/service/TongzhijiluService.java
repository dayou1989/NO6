...
public interface TongzhijiluService extends IService<TongzhijiluEntity> {
    ...
    PageUtils queryPage(Map<String, Object> params);
   	 ...
   	 * 查询发送失败的通知记录
   	 */
   	List<TongzhijiluEntity> selectFailedNotifications(Integer maxRetryCount);

   	/**
   	 * 查询待发送的通知记录
   	 */
   	List<TongzhijiluEntity> selectPendingNotifications();
   	 ...
   	 * 标记通知为已接收
   	 */
   	boolean markAsReceived(Long id);
   	
   	/**
   	 * 手动重试发送通知
   	 */
   	boolean manualRetry(Long id);
   	
   	/**
   	 * 立即发送通知
   	 */
   	void sendNotificationNow(TongzhijiluEntity notification) throws Exception;
}
